...
export const CONTENT_KIND_ORDER: ContentKind[] = ['mod', 'resourcepack', 'shader']

export const CONTENT_KIND_LABELS: Record<ContentKind, { plural: string; fileFilter: string }> = {
