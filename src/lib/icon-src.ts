 ...
 */
export function resolveIconSrc(iconPath: string | null | undefined): string | undefined {
  if (!iconPath) return undefined
  if (iconPath.startsWith('/picker/') || iconPath.startsWith('data:') || iconPath.startsWith('http')) return iconPath
