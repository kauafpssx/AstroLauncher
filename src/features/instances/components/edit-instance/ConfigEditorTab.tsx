...
export function ConfigEditorTab({ instanceId }: ConfigEditorTabProps) {
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col gap-3">
      ...
      <Tabs defaultValue="minecraft" className="flex min-h-0 min-w-0 flex-1 flex-col">
        <TabsList variant="line">
          <TabsTrigger value="minecraft">Minecraft</TabsTrigger>
          <TabsTrigger value="keybinds">Keybinds</TabsTrigger>
          <TabsTrigger value="mods">Mods</TabsTrigger>
        </TabsList>
        <TabsContent value="minecraft" className="min-h-0 min-w-0 overflow-y-auto">
          <MinecraftOptionsTab instanceId={instanceId} />
        </TabsContent>
        <TabsContent value="keybinds" className="min-h-0 min-w-0 overflow-y-auto">
