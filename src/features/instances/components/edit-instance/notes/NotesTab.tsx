...
import { WaypointManageDialog } from './waypoints/WaypointManageDialog'
...
export function NotesTab({ instanceId }: NotesTabProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-2">
      ...
      <div className="note-editor-content relative min-h-[420px] flex-1 resize-y overflow-auto rounded-lg border p-4">
